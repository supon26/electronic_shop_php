...
<section class="banner">
    ...
    <div class="img">
        <img src="../public/assets/image/fontend/images/image1.png" alt="">
    </div>
</section>
<!-- banner -->
...
<div class="container" id="product-cards">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr1.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr2.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr3.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr4.png" alt="">
                <div class="card-body">
    ...
    <div class="container" id="other">
        <div class="row">
            <div class="col-md-4 py-3 py-md-0">
                <div class="card shadow-lg">
                    <img src="../public/assets/image/fontend/images/c3.png" alt="">
                    <div class="card-img-overlay">
                        <h3>Home Gadget</h3>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card shadow-lg">
                    <img src="../public/assets/image/fontend/images/c4.png" alt="">
                    <div class="card-img-overlay">
                        <h3>Gaming Gadget</h3>
                        <p>Latest collection Up To 50% Off</p>
                    </div>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card shadow-lg">
                    <img src="../public/assets/image/fontend/images/c5.png" alt="">
                    <div class="card-img-overlay">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr5.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr6.png" alt="">
                <div class="card-body">
                    <h3 class="text-center">Fridge</h3>
                    <p class="text-center">Lorem ipsum dolor sit amet.</p>
                    <div class="star text-center">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr7.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr8.png" alt="">
                <div class="card-body">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr9.png" alt="">
                <div class="card-body">
                    <h3 class="text-center">Smart Watch</h3>
                    <p class="text-center">Lorem ipsum dolor sit amet.</p>
                    <div class="star text-center">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr10.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr11.png" alt="">
                <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
            <div class="card shadow-lg">
                <img src="../public/assets/image/fontend/images/pr12.png" alt="">
                <div class="card-body">
