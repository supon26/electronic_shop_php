                ...
                <section class="bg-light">
                    <div class="container bg-white">
                        <div class="d-flex align-items-center my-4">
                            <h1><i class="bi bi-calendar2-event-fill"></i></h1>
                            <h3 class="ms-3">Event</h3>
                        </div>
                    </div>
                    <div class="container">
                        <span>Title</span><br><br>
                        <input class="form-control" type="text" placeholder="2nd Gettogether-2023"
                            aria-label="default input example"><span class="text-muted ms-2">Description</span>
                        <input class="form-control" type="text" placeholder="bangladesh sweden polytecnic Institute"
                            aria-label="default input example"><span class="text-muted ms-2">Start Date</span>
                            <input class="form-control" type="text" placeholder="2023-02-10" aria-label="Disabled input example" disabled>
                            <span class="text-muted ms-2">End Date</span>
                            <input class="form-control mb-4" type="text" placeholder="2023-02-11" aria-label="Disabled input example" disabled>
                            <span class="text-muted ms-2">Image (Max-width X Max-height= 1116*742)</span>
